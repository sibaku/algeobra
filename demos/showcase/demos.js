...
function demoAddition(container, canvas) {
    ...
    const manip = vis.PointManipulator.createForPoints(scene, diagram.coordinateMapper, diagram.canvas, [arrowStart, p1, p2], 40);
...
function demoScale(container, canvas) {
    ...
    update();
    const manip = vis.PointManipulator.createForPoints(scene, diagram.coordinateMapper, diagram.canvas, [arrowStart, arrowEnd], 40);
...
function demoDot(container, canvas) {
    ...
    const manip = vis.PointManipulator.createForPoints(scene, diagram.coordinateMapper, diagram.canvas, [p0, p1, p2], 40);
...
function demoTrig(container, canvas) {
    ...
    const manip = vis.PointManipulator.createForPointsAndHandles(scene, diagram.coordinateMapper, diagram.canvas, [[circlePoint, handlePoint]], 40);
    onRemoved(canvas, () => {
        manip.detach();
        diagPainter.disconnect();
    });
